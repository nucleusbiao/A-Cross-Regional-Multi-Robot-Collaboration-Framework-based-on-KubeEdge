...
TASK_TOPIC = "$hw/events/device/" + "light" + "/twin/update"                      #mqtt topic
...
pin_pqrs=24          #The signal output pin of the sensor is connected to the BCM code of the raspberry pie pin
